...
{
    //Klasa odpowiada za wspólną część definicji tabeli "BikeStations".
    //Metoda używana następnie przez inne konfiguracje funkcjonujące w róznych środowiskach
    public class BikeStationCommonConfiguration
    {
        protected void Configure(EntityTypeBuilder<BikeStation> builder)
        {
