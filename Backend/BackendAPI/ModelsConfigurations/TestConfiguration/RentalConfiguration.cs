    ...
    public class RentalConfiguration : BackendAPI.ModelsConfigurations.CommonConfiguration.RentalConfiguration
    {
        public override void Configure(EntityTypeBuilder<Rental> builder)
        {
            ...
            builder.HasData(
                ...
                new Rental { ID = 6, UserID = 3, BikeID = 7, StartDate = new DateTime(2021, 3, 26, 12, 48, 34), EndDate = null },
                new Rental { ID = 7, UserID = 3, BikeID = 8, StartDate = new DateTime(2021, 3, 26, 12, 48, 34), EndDate = null },
                new Rental { ID = 8, UserID = 3, BikeID = 9, StartDate = new DateTime(2021, 3, 26, 12, 48, 34), EndDate = null },
                new Rental { ID = 9, UserID = 3, BikeID = 10, StartDate = new DateTime(2021, 3, 26, 12, 48, 34), EndDate = null }
                );
        }
    }
}
